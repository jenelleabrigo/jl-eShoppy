    ...
    <>
      <div className="flex items-center justify-end mb-7">
        <Dropdown label={category} style={{ backgroundColor: "#82015a", border: "2px solid #798c97" }}>
          <Dropdown.Item>
            <p value="All Items" onClick={getCatergory}>
              All Items
            </p>
          </Dropdown.Item>
          <Dropdown.Item>
            <p value="Men's Clothing" onClick={getCatergory}>
              Men's Clothing
            </p>
          </Dropdown.Item>
          <Dropdown.Item>
            <p value="Jewelery" onClick={getCatergory}>
              Jewelery
            </p>
          </Dropdown.Item>
          <Dropdown.Item>
            <p value="Electronics" onClick={getCatergory}>
              Electronics
            </p>
          </Dropdown.Item>
          <Dropdown.Item>
            <p value="Women's Clothing" onClick={getCatergory}>
              Women's Clothing
            </p>
          </Dropdown.Item>
        </Dropdown>
